...
func main() {
	...
	provisioner := provisioner.New(logger, gh, cfg.ArchetypesDirectory, cfg.DevelopmentFilesPath, cfg.GithubConfig.GoReleaserToken, cfg.GithubConfig.ReleasePleaseToken)
